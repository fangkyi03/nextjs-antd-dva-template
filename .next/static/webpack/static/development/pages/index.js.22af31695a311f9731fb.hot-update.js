...
function getOrCreateStore(initialState, modelList, store) {
  console.log('getOrCreateStore', isServer, modelList, store);
  ...
  console.log('输出12312', window[__NEXT_DVA_STORE__]);
  return window[__NEXT_DVA_STORE__]._store;
}
...
function createDva(modelList) {
  ...
  return function (Component) {
    var ComponentWithDva = function ComponentWithDva() {
      ...
      console.log('输出store', props, context);
...
//# sourceMappingURL=index.js.22af31695a311f9731fb.hot-update.js.map